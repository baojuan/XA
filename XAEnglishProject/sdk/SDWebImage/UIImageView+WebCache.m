...
- (void)setImageWithURL:(NSURL *)url completed:(SDWebImageCompletedBlock)completedBlock dealed:(MJWebImageDealedBlock)dealedBlock
{
    [self setImageWithURL:url placeholderImage:nil options:0 progress:nil completed:completedBlock dealedBlock:dealedBlock];
}
